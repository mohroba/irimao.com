...
<!doctype html><html lang="fa" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>استعلام کارت مسابقه</title><style>body{margin:0;padding:24px;background:#f4f5f7;color:#17134b;font-family:Tahoma,Arial,sans-serif}.result{max-width:520px;margin:10vh auto;padding:32px;border-radius:16px;background:#fff;box-shadow:0 10px 35px #0001;text-align:center}.status{font-size:22px;font-weight:700;color:<?php echo $valid ? '#16833b' : '#b42318'; ?>}.details{margin-top:22px;line-height:2}</style></head><body><main class="result"><div class="status"><?php echo $valid ? '✓ کارت مسابقه معتبر است' : 'کارت مسابقه معتبر نیست یا هنوز صادر نشده است'; ?></div><?php if ( $valid ) : ?><div class="details"><div><?php echo esc_html( $name ); ?></div><div><?php echo esc_html( get_the_title( $competition_id ) ); ?></div><?php if ( self::item_is_weighed_in( $item ) ) : ?><div>وزن تأییدشده: <?php echo esc_html( (string) $item->get_meta( self::META_WEIGHT, true ) ); ?> KG</div><?php endif; ?></div><?php endif; ?></main></body></html>
    ...
    public static function qr_data_uri( string $content ): string {
        $renderer = new ImageRenderer( new RendererStyle( 420, 1 ), new SvgImageBackEnd() );
...
<style>
*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:#202124;font-family:Tahoma,Arial,sans-serif}.toolbar{position:sticky;top:0;z-index:2;padding:10px;text-align:center;background:#fff}.toolbar button{padding:8px 20px;border:0;border-radius:5px;background:#17134b;color:#fff;font:700 14px Tahoma;cursor:pointer}.page{display:flex;justify-content:center;padding:18px}.card{position:relative;width:min(92vw,574px);aspect-ratio:565/776;background:center/100% 100% no-repeat;overflow:hidden;box-shadow:0 8px 30px #0008}.competition-date{position:absolute;z-index:2;top:39.5%;left:2%;width:86%;height:6%;display:flex;align-items:center;justify-content:center;background:#fff;color:#c32921;font-size:clamp(12px,2.7vw,20px);font-weight:700;white-space:nowrap}.field{position:absolute;z-index:3;right:40%;width:22%;height:4.3%;display:flex;align-items:center;color:#050505;padding:0;font-weight:700;font-size:clamp(11px,2.1vw,18px);line-height:1}.field b{display:none}.field span{width:100%;text-align:right;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.name{top:48.85%;right:40%;width:30%}.national-id{top:54.85%}.province{top:60.85%}.weight{top:66.85%}.age{top:72.85%}.insurance{top:78.85%;right:37%;width:15%}.photo{position:absolute;z-index:3;left:3.5%;top:45.2%;width:28%;height:24%;background:#fff;border:3px solid #070707;object-fit:cover}.qr{position:absolute;z-index:3;left:2%;top:86%;width:15%;height:11%;display:block;background:#fff;object-fit:contain}.print-note{display:none}
